...
type Tab = "home" | "conversations" | "contacts" | "webhook" | "dashboard" | "chat" | "productos" | "pedidos" | "contabilidad" | "conectar";
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100vh", background: "#0a0c10", fontFamily: "'Segoe UI', system-ui, sans-serif" }}>
      ...
      {tab === "productos" ? (
        ...
        <div style={{ flex: 1, overflow: "hidden" }}>
          <iframe src="/contabilidad.html" style={{ width: "100%", height: "100%", border: "none" }} />
        </div>
      ) : tab === "conectar" ? (
